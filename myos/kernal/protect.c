...
PUBLIC void init_prot()
{
    ...
    tss.ss0=SELECTOR_KERNAL_DS;
    init_descriptor(&gdt[INDEX_TSS],
    	vir2phys(seg2phys(SELECTOR_KERNAL_DS),&tss),
    ...
    for(i=0;i<NUM_TASKS+NUM_USERS;++i)
    {
    	init_descriptor(&gdt[selector_ldt>>3],
    		vir2phys(seg2phys(SELECTOR_KERNAL_DS),proc_table[i].ldts),
			  ...
			  int_handler handler, unsigned char privilege)
{
	...
	p_gate->selector = SELECTOR_KERNAL_CS;
	p_gate->dcount = 0;
